...
from any working directory, and reads every path from ``.env``: the
    ...
    if in_databricks_notebook():
        ...
        if not proxy:
            lines += [
                ...
                "  it. Run it on your own machine instead - see START_HERE.md,",
                "  which is what this branch is built for.",
                "",
            ]
    if runs:
